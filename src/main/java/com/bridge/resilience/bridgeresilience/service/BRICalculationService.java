...
public class BRICalculationService {
    ...
    private static Logger logger = LoggerFactory.getLogger(BRICalculationService.class);
    private static DecimalFormat dbig=new DecimalFormat("#.##");
    private static DecimalFormat dbig1=new DecimalFormat("#.####");
    public double getsaveAndGenrateBRIValue(BRI thebri){
    ...
    public double getSubMainValue(String splus,String snegative){
        double submainvalue=Double.parseDouble(dbig.format(Double.parseDouble(splus)/(Double.parseDouble(splus)+Double.parseDouble(snegative))));
        return submainvalue;
    }
}
